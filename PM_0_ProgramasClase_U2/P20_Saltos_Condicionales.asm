...
cadena_1_p20 db "Mensaje 1",0
cadena_2_p20 db "Mensaje 2",0
cadena_3_p20 db "Mensaje 3",0
cadena_4_p20 db "Mensaje 4",0
...
mov edx, offset cadena_1_p20
call writestring

jmp continuar

mov edx, offset cadena_2_p20
call writestring

mov edx, offset cadena_3_p20
call writestring

continuar:

mov edx, offset cadena_4_p20
call writestring
